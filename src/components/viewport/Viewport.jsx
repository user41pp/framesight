...
const Viewport = forwardRef(function Viewport(
  { cameraRef, imgRef, videoRef, overlayRef, imgSrc, activeSource, onCameraLoad, onImageLoad, onVideoReady, onStartCamera, fps, timing },
  ref
) {
  ...
  return (
    ...
    >
      ...
      <video
        ...
        className={activeSource === 'video' ? '' : 'hidden'}
      />
